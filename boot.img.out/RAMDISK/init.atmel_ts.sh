...
cd /sys/bus/i2c/devices/12-004a
...
#for pid (pid name = 01)
echo "A4_35_1.0_AA.fw" > update_fw
...
#[4] : WDG
#[7] : PLUG PAUSE
echo "ac enable 1" > plugin

echo "pl enable 20" > plugin
...
#echo "TAP 1;m 1;w 1;c 1;o 1;v 1" > gesture_list
