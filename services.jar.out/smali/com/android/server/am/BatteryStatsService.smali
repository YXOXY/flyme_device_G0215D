...
.method private pullWifiEnergyInfoLocked()Landroid/net/wifi/WifiActivityEnergyInfo;
    ...
    invoke-interface/range {v21 .. v21}, Landroid/net/wifi/IWifiManager;->getWifiEnabledState()I
    ...
    .line 1338
    const-string/jumbo v21, "BatteryStatsService"

    const-string/jumbo v22, "Wifi is in disabled state"
    ...
    invoke-interface/range {v21 .. v21}, Landroid/net/wifi/IWifiManager;->reportActivityInfo()Landroid/net/wifi/WifiActivityEnergyInfo;

    move-result-object v5

    .line 1344
    .local v5, "info":Landroid/net/wifi/WifiActivityEnergyInfo;
    if-eqz v5, :cond_7
    ...
    .line 1345
    iget-wide v0, v5, Landroid/net/wifi/WifiActivityEnergyInfo;->mControllerEnergyUsed:J
    ...
    const-string/jumbo v23, "Reported WiFi energy data is invalid: "
    ...
    .line 1351
    iget-wide v0, v5, Landroid/net/wifi/WifiActivityEnergyInfo;->mTimestamp:J
    ...
    iget-wide v8, v0, Landroid/net/wifi/WifiActivityEnergyInfo;->mControllerIdleTimeMs:J
    ...
    iget-wide v12, v0, Landroid/net/wifi/WifiActivityEnergyInfo;->mControllerTxTimeMs:J
    ...
    iget-wide v10, v0, Landroid/net/wifi/WifiActivityEnergyInfo;->mControllerRxTimeMs:J
    ...
    iget-wide v6, v0, Landroid/net/wifi/WifiActivityEnergyInfo;->mControllerEnergyUsed:J

    .line 1359
    .local v6, "lastEnergy":J
    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/server/am/BatteryStatsService;->mLastInfo:Landroid/net/wifi/WifiActivityEnergyInfo;

    .line 1360
    .local v14, "result":Landroid/net/wifi/WifiActivityEnergyInfo;
    invoke-virtual {v5}, Landroid/net/wifi/WifiActivityEnergyInfo;->getTimeStamp()J

    move-result-wide v22

    move-wide/from16 v0, v22

    iput-wide v0, v14, Landroid/net/wifi/WifiActivityEnergyInfo;->mTimestamp:J

    .line 1361
    invoke-virtual {v5}, Landroid/net/wifi/WifiActivityEnergyInfo;->getStackState()I

    move-result v21

    move/from16 v0, v21

    iput v0, v14, Landroid/net/wifi/WifiActivityEnergyInfo;->mStackState:I
    ...
    iput-wide v0, v14, Landroid/net/wifi/WifiActivityEnergyInfo;->mControllerTxTimeMs:J
    ...
    iput-wide v0, v14, Landroid/net/wifi/WifiActivityEnergyInfo;->mControllerRxTimeMs:J
    ...
    iput-wide v0, v14, Landroid/net/wifi/WifiActivityEnergyInfo;->mControllerIdleTimeMs:J
    ...
    iput-wide v0, v14, Landroid/net/wifi/WifiActivityEnergyInfo;->mControllerEnergyUsed:J

    .line 1375
    iget-wide v0, v14, Landroid/net/wifi/WifiActivityEnergyInfo;->mControllerTxTimeMs:J
    ...
    .line 1376
    iget-wide v0, v14, Landroid/net/wifi/WifiActivityEnergyInfo;->mControllerRxTimeMs:J
    ...
    const-string/jumbo v23, "WiFi energy data was reset, new WiFi energy data is "
    ...
    iget-wide v0, v14, Landroid/net/wifi/WifiActivityEnergyInfo;->mControllerIdleTimeMs:J
    ...
    const-string/jumbo v21, "Total time "
    ...
    .line 1395
    const-string/jumbo v21, " is longer than sample period "
    ...
    .line 1398
    const-string/jumbo v21, "Previous WiFi snapshot: "
    ...
    const-string/jumbo v22, "idle="

    invoke-virtual/range {v21 .. v22}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    .line 1399
    invoke-static {v8, v9, v15}, Landroid/util/TimeUtils;->formatDuration(JLjava/lang/StringBuilder;)V

    .line 1400
    const-string/jumbo v21, " rx="
    ...
    .line 1401
    invoke-static {v10, v11, v15}, Landroid/util/TimeUtils;->formatDuration(JLjava/lang/StringBuilder;)V

    .line 1402
    const-string/jumbo v21, " tx="
    ...
    .line 1403
    invoke-static {v12, v13, v15}, Landroid/util/TimeUtils;->formatDuration(JLjava/lang/StringBuilder;)V

    .line 1404
    const-string/jumbo v21, " e="
    ...
    .line 1406
    const-string/jumbo v21, "Current WiFi snapshot: "
    ...
    .end local v5    # "info":Landroid/net/wifi/WifiActivityEnergyInfo;
    .end local v6    # "lastEnergy":J
    .end local v8    # "lastIdleMs":J
    .end local v10    # "lastRxMs":J
    .end local v12    # "lastTxMs":J
    .end local v14    # "result":Landroid/net/wifi/WifiActivityEnergyInfo;
