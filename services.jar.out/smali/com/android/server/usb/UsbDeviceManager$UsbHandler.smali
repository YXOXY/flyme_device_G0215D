...
.method private publishAdbCustomTile()V
    ...
    invoke-static {v10}, Lcom/android/server/usb/UsbDeviceManager;->-get6(Lcom/android/server/usb/UsbDeviceManager;)Landroid/content/Context;

    move-result-object v10

    .line 936
    const-string/jumbo v11, "adb"

    .line 935
    invoke-static {v10, v9, v11}, Lorg/cyanogenmod/internal/util/QSUtils;->getDynamicQSTileResIconId(Landroid/content/Context;ILjava/lang/String;)I
    ...
    .line 937
    invoke-static {v10, v9, v11}, Lorg/cyanogenmod/internal/util/QSUtils;->getDynamicQSTileLabel(Landroid/content/Context;ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v10, v9}, Lorg/cyanogenmod/internal/util/QSUtils;->getQSTileContext(Landroid/content/Context;I)Landroid/content/Context;

    move-result-object v3

    .line 941
    .local v3, "resourceContext":Landroid/content/Context;
    iget-object v10, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->this$0:Lcom/android/server/usb/UsbDeviceManager;
    ...
    invoke-static {v10}, Lcyanogenmod/app/CMStatusBarManager;->getInstance(Landroid/content/Context;)Lcyanogenmod/app/CMStatusBarManager;

    move-result-object v4

    .line 942
    .local v4, "statusBarManager":Lcyanogenmod/app/CMStatusBarManager;
    new-instance v10, Lcyanogenmod/app/CustomTile$Builder;

    invoke-direct {v10, v3}, Lcyanogenmod/app/CustomTile$Builder;-><init>(Landroid/content/Context;)V
    ...
    .line 942
    invoke-virtual {v10, v11}, Lcyanogenmod/app/CustomTile$Builder;->setLabel(Ljava/lang/String;)Lcyanogenmod/app/CustomTile$Builder;

    move-result-object v10

    invoke-virtual {v10, v0}, Lcyanogenmod/app/CustomTile$Builder;->setContentDescription(Ljava/lang/String;)Lcyanogenmod/app/CustomTile$Builder;

    move-result-object v10

    invoke-virtual {v10, v2}, Lcyanogenmod/app/CustomTile$Builder;->setIcon(I)Lcyanogenmod/app/CustomTile$Builder;
    ...
    .line 942
    invoke-virtual {v10, v11}, Lcyanogenmod/app/CustomTile$Builder;->setOnClickIntent(Landroid/app/PendingIntent;)Lcyanogenmod/app/CustomTile$Builder;

    move-result-object v10

    invoke-virtual {v10}, Lcyanogenmod/app/CustomTile$Builder;->build()Lcyanogenmod/app/CustomTile;

    move-result-object v5

    .line 948
    .local v5, "tile":Lcyanogenmod/app/CustomTile;
    const-string/jumbo v10, "adb"

    .line 949
    const-class v11, Lcom/android/server/usb/UsbDeviceManager;

    invoke-virtual {v11}, Ljava/lang/Class;->hashCode()I

    move-result v11

    .line 948
    invoke-virtual {v4, v10, v11, v5, v8}, Lcyanogenmod/app/CMStatusBarManager;->publishTileAsUser(Ljava/lang/String;ILcyanogenmod/app/CustomTile;Landroid/os/UserHandle;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .end local v2    # "icon":I
    .end local v3    # "resourceContext":Landroid/content/Context;
    .end local v4    # "statusBarManager":Lcyanogenmod/app/CMStatusBarManager;
    .end local v5    # "tile":Lcyanogenmod/app/CustomTile;
    ...
    :try_start_1
    const-string/jumbo v10, "wmg"

    const-string/jumbo v11, "publishAdbCustomTile error "
